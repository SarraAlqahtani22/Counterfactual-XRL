...
import wandb
wandb.init(name='Counterfactual', project="counterfactual_based_attack")
...
def parse_args():
    ...
    parser.add_argument("--save-rate", type=int, default=50, help="save model once every time this many episodes are completed") #originally 1000
...
def train(arglist):
    with U.single_threaded_session() as marl_sess:
        ...
        if loaded:
            ...
            saver_DDPG.restore(marl_sess, './weights_DDPG_Adv_CN_final/')
        ...
        while True:
            ...
            if terminal and (len(episode_rewards) % arglist.save_rate == 0):
                ...
                if num_adversaries == 0:
                    ...
                    sum += np.mean(reward_good[-arglist.save_rate:])
                    counter += 1
                else:
            ...
            if len(episode_rewards) > arglist.num_episodes:
                print("final ans is " + str(sum/counter))
