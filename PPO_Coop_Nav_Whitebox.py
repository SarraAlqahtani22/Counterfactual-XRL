...
import wandb
wandb.init(name='Counterfactual - PPO_Whitebox - all', project="simple_spread")
...
def parse_args():
    ...
    parser.add_argument("--save-rate", type=int, default=50, help="save model once every time this many episodes are completed") #1000
